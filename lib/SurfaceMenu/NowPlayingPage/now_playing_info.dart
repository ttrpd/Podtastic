...
class NowPlayingInfo extends StatefulWidget {
  ...
  @override
  _NowPlayingInfoState createState() => _NowPlayingInfoState();
}

class _NowPlayingInfoState extends State<NowPlayingInfo> {
  @override
  Widget build(BuildContext context) {
    return AnimatedOpacity(
      opacity: widget.showNowPlaying ? 1.0 : 0.0,
